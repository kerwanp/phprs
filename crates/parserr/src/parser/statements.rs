...
impl<'a> Statement<'a> {
        ...
        I: ValueInput<'a, Token = Token<'a>, Span = SimpleSpan>,
    {
        recursive(|parser| {
            ...
            echo_statement
                .or(named_label_statement)
                .or(expression_statement)
                .or(namespace_use_declaration)
                ...
                .or(throw_statement)
                .or(unset_statement)
                .or(namespace_definition)
                .or(const_declaration)
                .or(global_declaration)
                .or(function_definition)
                .or(function_static_declaration)
                .or(declare_statement)
                .or(try_statement)
                .or(foreach_statement)
